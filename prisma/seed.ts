...
async function main() {
  ...
  const aspirasiData = [
    ...
    { id: 'a-006', sumber: 'CALL_CENTER' as const, deskripsi: 'Laporan warga tentang tiang listrik miring di Jl. Raya Lenteng Agung yang membahayakan pengguna jalan.', status: 'BELUM_DITINDAKLANJUTI' as const, pelapor_nama: 'Rudi Hartono', pelapor_email: '', pelapor_telepon: '081234567895', kategori_usulan: 'Infrastruktur', jenis_usulan: 'Pembangunan', jenis_reses: 'Reses Periode I', tindak_lanjut: 'Belum ditindaklanjuti', tanggal_dibuat: new Date('2026-01-15') },
