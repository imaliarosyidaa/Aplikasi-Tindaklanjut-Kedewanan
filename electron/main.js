...
if (!isDev) {
  ...
  if (
    !fs.existsSync(path.join(unpackedPrismaRoot, 'client', 'runtime', 'client.js')) &&
    fs.existsSync(path.join(appAsarUnpackedRoot, 'client', 'runtime', 'client.js'))
  ) {
...
function createWindow() {
  mainWindow = new BrowserWindow({
    ...
    minWidth: 1024,
    minHeight: 600,
    icon: path.join(__dirname, '..', 'public', 'Lambang_DPRD.png'),
    webPreferences: {
