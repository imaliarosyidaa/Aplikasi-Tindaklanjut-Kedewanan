...
export function Hero04({
  ...
  const backgroundElement = washImage && (
    <div aria-hidden className="pointer-events-none absolute inset-0 z-0 opacity-75 blur-xl dark:opacity-5">
  ...
  const descriptionElement = description && (
    <p className={cn('text-[var(--color-text-secondary)] text-balance', vs.description)}>{description}</p>
  )
  ...
  return (
    <section id="about" className="bg-[var(--color-bg)] relative isolate w-full overflow-hidden">
      {backgroundElement}
