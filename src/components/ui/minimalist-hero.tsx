  ...
  return (
    ...
    >
      ...
      <div className="relative grid w-full max-w-7xl flex-grow grid-cols-1 items-center md:grid-cols-3">
        ...
        >
          <p className="mx-auto mt-24 md:mt-0 max-w-xs text-sm leading-relaxed text-foreground/80 md:mx-0">
            {mainText}
          </p>
          <a
            href={readMoreLink}
        ...
        <div className="relative top-8 md:top-0 order-1 md:order-2 flex justify-center items-center h-full">
          <motion.div
            initial={{ scale: 0.8, opacity: 0 }}
            animate={{ scale: 1, opacity: 1 }}
            transition={{ duration: 0.8, ease: [0.22, 1, 0.36, 1], delay: 0.2 }}
            className="absolute z-0 h-[200px] w-[200px] rounded-full bg-black/90 md:h-[400px] md:w-[400px] lg:h-[300px] lg:w-[300px]"
          ></motion.div>
          <motion.img
            src={imageSrc}
            alt={imageAlt}
