...
const activities = [
  ...
  {
    id: 'musrembang_kedewanan',
    title: 'Musrembang Kedewanan',
    desc: 'Musyarwarah rencana pembangunan yang bersumber dari suara masyarakat',
    icon: ClipboardList,
  },
  {
    id: 'rapat_kerja_komisi',
    title: 'Rapat Kerja Komisi / Rapat Pansus / Rapat Banggar / Rapat Paripurna',
